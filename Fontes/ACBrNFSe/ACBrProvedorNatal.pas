...
(*
function TProvedorNatal.Gera_DadosMsgEnviarLote(Prefixo3, Prefixo4,
...
function TProvedorNatal.Gera_DadosMsgConsSitLote(Prefixo3, Prefixo4,
...
function TProvedorNatal.Gera_DadosMsgConsLote(Prefixo3, Prefixo4,
  NameSpaceDad, VersaoXML, Protocolo, CNPJ, IM: String; TagI,
  TagF: AnsiString): AnsiString;
var
 DadosMsg: AnsiString;
...
function TProvedorNatal.Gera_DadosMsgConsNFSeRPS(Prefixo3, Prefixo4,
...
function TProvedorNatal.Gera_DadosMsgConsNFSe(Prefixo3, Prefixo4,
...
function TProvedorNatal.Gera_DadosMsgCancelarNFSe(Prefixo4, NameSpaceDad, NumeroNFSe,
...
function TProvedorNatal.Gera_DadosMsgGerarNFSe(Prefixo3, Prefixo4,
  Identificador, NameSpaceDad, VersaoDados, VersaoXML, NumeroLote, CNPJ,
  IM, QtdeNotas: String; Notas, TagI, TagF: AnsiString): AnsiString;
begin
 Result := '';
...
(*
function TProvedorNatal.Gera_DadosMsgEnviarSincrono(Prefixo3, Prefixo4,
  Identificador, NameSpaceDad, VersaoDados, VersaoXML, NumeroLote, CNPJ,
  IM, QtdeNotas: String; Notas, TagI, TagF: AnsiString): AnsiString;
begin
 Result := '';
