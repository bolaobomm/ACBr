...
function TProvedorProdemge.GetConfigCidade(ACodCidade,
...
function TProvedorProdemge.GetConfigSchema(ACodCidade: Integer): TConfigSchema;
var
...
function TProvedorProdemge.GetConfigURL(ACodCidade: Integer): TConfigURL;
var
...
function TProvedorProdemge.Gera_DadosMsgCancelarNFSe(Prefixo4, NameSpaceDad, NumeroNFSe,
...
function TProvedorProdemge.GetLinkNFSe(ACodMunicipio, ANumeroNFSe: Integer;
  ACodVerificacao, AInscricaoM: String; AAmbiente: Integer): String;
begin
 Result := '';
end;
(*
function TProvedorProdemge.Gera_DadosMsgEnviarSincrono(Prefixo3, Prefixo4,
  Identificador, NameSpaceDad, VersaoDados, VersaoXML, NumeroLote, CNPJ,
  IM, QtdeNotas: String; Notas, TagI, TagF: AnsiString): AnsiString;
begin
 Result := '';
...
*)
function TProvedorProdemge.GeraEnvelopeRecepcionarSincrono(URLNS: String;
  CabMsg, DadosMsg, DadosSenha: AnsiString): AnsiString;
begin
 Result := '';
end;
