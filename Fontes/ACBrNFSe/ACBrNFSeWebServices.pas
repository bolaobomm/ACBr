 ...
 if (FProvedor = proIssDSF)
  then begin
   ...
   FDadosMsg := TNFSeG.Gera_DadosMsgEnviarLoteDSF(Prefixo3, Prefixo4,
                                                      ...
                                                      booltostr(TNFSeEnviarLoteRPS(Self).FNotasFiscais.Transacao, False),
  ...
  then begin
   if (FProvedor = proIssDSF)
    then FDadosMsg := TNFSeG.Gera_DadosMsgConsNFSeRPSDSF(Prefixo3, Prefixo4,
                                                         ...
                                                         booltostr(TNFSeConsultarNfseRPS(Self).FNotasFiscais.Transacao, False),
  ...
  then begin
   if (FProvedor = proIssDSF)
    then FDadosMsg := TNFSeG.Gera_DadosMsgCancelarNFSeDSF(Prefixo3, Prefixo4,
                                                          ...
                                                          booltostr(TNFSeCancelarNfse(Self).FNotasFiscais.Transacao, False),
  ...
  then begin
    ...
    for i := 0 to TNFSeEnviarLoteRPS(Self).FNotasFiscais.Count-1 do begin
       ...
       FDadosMsg := TNFSeG.Gera_DadosMsgEnviarLoteDSF(Prefixo3, Prefixo4,
                                                      ...
                                                      booltostr(TNFSeGerarLoteRPS(Self).FNotasFiscais.Transacao, False),
