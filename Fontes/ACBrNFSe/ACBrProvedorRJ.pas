...
type
 ...
 TProvedorRJ = class(TProvedorClass)
  protected
   { protected }
  private
   { private }
...
constructor TProvedorRJ.Create;
begin
 {----}
end;
...
function TProvedorRJ.GetConfigURL(ACodCidade: Integer): TConfigURL;
var
...
function TProvedorRJ.GetURI(URI: String): String;
begin
 Result := URI;
end;

function TProvedorRJ.GetAssinarXML(Acao: TnfseAcao): Boolean;
begin
 case Acao of
...
function TProvedorRJ.GetValidarLote: Boolean;
begin
 Result := True;
end;

function TProvedorRJ.Gera_TagI(Acao: TnfseAcao; Prefixo3, Prefixo4,
...
function TProvedorRJ.Gera_DadosSenha(CNPJ, Senha: String): AnsiString;
begin
 Result := '';
end;

function TProvedorRJ.Gera_TagF(Acao: TnfseAcao; Prefixo3: String): AnsiString;
begin
 case Acao of
...
(*
function TProvedorRJ.Gera_DadosMsgEnviarLote(Prefixo3, Prefixo4,
...
function TProvedorRJ.Gera_DadosMsgConsSitLote(Prefixo3, Prefixo4,
...
function TProvedorRJ.Gera_DadosMsgConsLote(Prefixo3, Prefixo4,
  NameSpaceDad, VersaoXML, Protocolo, CNPJ, IM: String; TagI,
  TagF: AnsiString): AnsiString;
var
 DadosMsg: AnsiString;
...
function TProvedorRJ.Gera_DadosMsgConsNFSeRPS(Prefixo3, Prefixo4,
...
function TProvedorRJ.Gera_DadosMsgConsNFSe(Prefixo3, Prefixo4, NameSpaceDad, VersaoXML,
  CNPJ, IM: String; DataInicial, DataFinal: TDateTime; TagI,
...
function TProvedorRJ.Gera_DadosMsgCancelarNFSe(Prefixo4, NameSpaceDad, NumeroNFSe, CNPJ,
  IM, CodMunicipio, CodCancelamento: String; TagI,
  TagF: AnsiString): AnsiString;
var
 DadosMsg: AnsiString;
begin
...
function TProvedorRJ.Gera_DadosMsgGerarNFSe(Prefixo3, Prefixo4,
  Identificador, NameSpaceDad, VersaoDados, VersaoXML, NumeroLote, CNPJ,
  IM, QtdeNotas: String; Notas, TagI, TagF: AnsiString): AnsiString;
begin
 Result := '';
...
begin
 case Acao of
   acRecepcionar: Result := 'http://notacarioca.rio.gov.br/RecepcionarLoteRps';
   acConsSit:     Result := 'http://notacarioca.rio.gov.br/ConsultarSituacaoLoteRps';
   acConsLote:    Result := 'http://notacarioca.rio.gov.br/ConsultarLoteRps';
...
function TProvedorRJ.GetRetornoWS(Acao: TnfseAcao; RetornoWS: AnsiString): AnsiString;
begin
 case Acao of
...
(*
function TProvedorRJ.Gera_DadosMsgEnviarSincrono(Prefixo3, Prefixo4,
  Identificador, NameSpaceDad, VersaoDados, VersaoXML, NumeroLote, CNPJ,
  IM, QtdeNotas: String; Notas, TagI, TagF: AnsiString): AnsiString;
begin
