...
(*
function TProvedorCoplan.Gera_DadosMsgEnviarLote(Prefixo3, Prefixo4,
...
function TProvedorCoplan.Gera_DadosMsgConsSitLote(Prefixo3, Prefixo4,
...
function TProvedorCoplan.Gera_DadosMsgConsLote(Prefixo3, Prefixo4,
  NameSpaceDad, VersaoXML, Protocolo, CNPJ, IM: String; TagI,
  TagF: AnsiString): AnsiString;
var
 DadosMsg: AnsiString;
...
function TProvedorCoplan.Gera_DadosMsgConsNFSe(Prefixo3, Prefixo4,
...
function TProvedorCoplan.Gera_DadosMsgConsNFSeRPS(Prefixo3, Prefixo4,
...
function TProvedorCoplan.Gera_DadosMsgCancelarNFSe(Prefixo4, NameSpaceDad, NumeroNFSe,
...
function TProvedorCoplan.Gera_DadosMsgGerarNFSe(Prefixo3, Prefixo4,
  Identificador, NameSpaceDad, VersaoDados, VersaoXML, NumeroLote, CNPJ,
  IM, QtdeNotas: String; Notas, TagI, TagF: AnsiString): AnsiString;
begin
 Result := Notas;
