...
begin
  ...
  try
    ...
    if leitor.rExtrai(1, Prefixo3 + 'ConsultarNfseRpsResposta') <> '' then
    begin
      // Ler a NFSe

      i := 0;
      // Alterado por Rodrigo Cantelli
      while (Leitor.rExtrai(2, Prefixo3 + 'CompNfse', '', i + 1) <> '') or
            (Leitor.rExtrai(2, Prefixo3 + 'ComplNfse', '', i + 1) <> '') do
      begin
        ListaNfse.FCompNfse.Add;

        // Grupo da TAG <Nfse> *************************************************
        if Leitor.rExtrai(3, Prefixo4 + 'Nfse') <> ''
         then begin
          // Grupo da TAG <InfNfse> *****************************************************
          if Leitor.rExtrai(4, Prefixo4 + 'InfNfse') <> ''
           then begin
            ...
            if Leitor.rExtrai(5, Prefixo4 + 'IdentificacaoRps') <> ''
             then begin
            ...
            if Leitor.rExtrai(5, Prefixo4 + 'RpsSubstituido') <> ''
             then begin
            ...
            if Leitor.rExtrai(5, Prefixo4 + 'Servico') <> ''
             then begin
...
//                ListaNfse.FCompNfse[i].FNFSe.Servico.xItemListaServico := ObterDescricaoServico(ListaNfse.FCompNfse[i].FNFSe.Servico.ItemListaServico);
              ...
              if Leitor.rExtrai(6, Prefixo4 + 'Valores') <> ''
               then begin
            ...
            if Leitor.rExtrai(5, Prefixo4 + 'PrestadorServico') <> ''
             then begin
...
//                                                       StrToIntDef(ListaNfse.FCompNfse[i].FNFSe.PrestadorServico.Endereco.CodigoMunicipio, 0)))));
              ...
              if Leitor.rExtrai(6, Prefixo4 + 'Contato') <> ''
               then begin
              ...
              if Leitor.rExtrai(6, Prefixo4 + 'IdentificacaoPrestador') <> ''
               then begin
                if VersaoXML='1'
                 then begin
            ...
            if Leitor.rExtrai(5, Prefixo4 + 'Prestador') <> ''
             then begin
            ...
            if Leitor.rExtrai(5, Prefixo4 + 'TomadorServico') <> ''
             then begin
...
//                                                       StrToIntDef(ListaNfse.FCompNfse[i].FNFSe.Tomador.Endereco.CodigoMunicipio, 0)))));
              ...
              if Leitor.rExtrai(6, Prefixo4 + 'IdentificacaoTomador') <> ''
               then begin
            ...
            if Leitor.rExtrai(5, Prefixo4 + 'Tomador') <> ''
             then begin
              ListaNfse.FCompNfse[i].FNFSe.Tomador.RazaoSocial := Leitor.rCampo(tcStr, Prefixo4 + 'RazaoSocial');
...
//                                                       StrToIntDef(ListaNfse.FCompNfse[i].FNFSe.Tomador.Endereco.CodigoMunicipio, 0)))));
            ...
            if Leitor.rExtrai(5, Prefixo4 + 'IntermediarioServico') <> ''
             then begin
              ...
              if Leitor.rExtrai(6, Prefixo4 + 'CpfCnpj') <> ''
               then begin
                if Leitor.rCampo(tcStr, Prefixo4 + 'Cpf')<>''
            ...
            if Leitor.rExtrai(5, Prefixo4 + 'OrgaoGerador') <> ''
             then begin
            ...
            if Leitor.rExtrai(5, Prefixo4 + 'ConstrucaoCivil') <> ''
             then begin
