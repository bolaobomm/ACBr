...
begin
 case Acao of
   acRecepcionar: Result := 'Abrasf2action/ARECEPCIONARLOTERPSSINCRONO.Execute';
...
begin
 case Acao of
   ...
   acGerar:       begin
                   RetWS := SeparaDados( RetornoWS, 'GerarNfse.ExecuteResponse' );
                   RetWS := RetWS + '</GerarNfse.ExecuteResponse>';
                   Result := RetWS;
                  end;
 end;
end;
