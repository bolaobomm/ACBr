...

{
  ...
  Wouter van Nifterick, 2012-02-25: added two functions:
    - HashString()  Creates a Hash from a string
    - SHA1          Works exactly like the SHA1() in PHP and MySQL
...
procedure HashString(s: AnsiString; var Digest: TSHA1Digest);
