...
begin
  case ALayOut of
    LayGNRERecepcao:          Result := DFeUtil.SeSenao(AAmbiente = 1, 'https://www.gnre.pe.gov.br/gnreWS/services/GnreLoteRecepcao?wsdl'   , 'https://www.testegnre.pe.gov.br/gnreWS/services/GnreLoteRecepcao?wsdl');
    LayGNRERetRecepcao:       Result := DFeUtil.SeSenao(AAmbiente = 1, 'https://www.gnre.pe.gov.br/gnreWS/services/GnreResultadoLote?wsdl'  , 'https://www.testegnre.pe.gov.br/gnreWS/services/GnreResultadoLote?wsdl');
    LayGNREConsultaConfigUF:  Result := DFeUtil.SeSenao(AAmbiente = 1, 'https://www.gnre.pe.gov.br/gnreWS/services/GnreConfigUF?wsdl'       , 'https://www.testegnre.pe.gov.br/gnreWS/services/GnreConfigUF?wsdl');
  end;
end;
