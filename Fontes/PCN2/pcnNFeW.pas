         ...
         begin
            ...
            case nfe.Det[i].Imposto.ICMS.CST of
               ...
               cstPart10 :
                    ...
                    Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'N19', 'pMVAST  ', 01, 05, 0, nfe.Det[i].Imposto.ICMS.pMVAST, DSC_PMVAST);
                    Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'N20', 'pRedBCST', 01, 05, 0, nfe.Det[i].Imposto.ICMS.pRedBCST, DSC_PREDBCST);
                    Gerador.wCampo(tcDe2, 'N21', 'vBCST   ', 01, 15, 1, nfe.Det[i].Imposto.ICMS.vBCST, DSC_VBCST);
                    Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'N22', 'pICMSST ', 01, 05, 1, nfe.Det[i].Imposto.ICMS.pICMSST, DSC_PICMSST);
                    Gerador.wCampo(tcDe2, 'N23', 'vICMSST ', 01, 15, 1, nfe.Det[i].Imposto.ICMS.vICMSST, DSC_VICMSST);
                    if (nfe.Det[i].Imposto.ICMS.UFST <> '') or
                       (nfe.Det[i].Imposto.ICMS.pBCOp <> 0) or
                       (nfe.Det[i].Imposto.ICMS.CST = cstPart10) then
                     begin
                       Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'N25', 'pBCOp   ', 01, 05, 1, nfe.Det[i].Imposto.ICMS.pBCOp, DSC_PBCOP);
               ...
               cst20 :
                  begin
                    Gerador.wCampo(tcStr, 'N13', 'modBC   ', 01, 01, 1, modBCToStr(nfe.Det[i].Imposto.ICMS.modBC), DSC_MODBC);
                    Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'N14', 'pRedBC  ', 01, 05, 1, nfe.Det[i].Imposto.ICMS.pRedBC, DSC_PREDBC);
                    Gerador.wCampo(tcDe2, 'N15', 'vBC     ', 01, 15, 1, nfe.Det[i].Imposto.ICMS.vBC, DSC_VBC);
                    Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'N16', 'pICMS   ', 01, 05, 1, nfe.Det[i].Imposto.ICMS.pICMS, DSC_PICMS);
                    Gerador.wCampo(tcDe2, 'N17', 'vICMS   ', 01, 15, 1, nfe.Det[i].Imposto.ICMS.vICMS, DSC_VICMS);
               ...
               cst51 :
                  begin
                    ...
                    Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'N14', 'pRedBC   ', 01, 05, 0, nfe.Det[i].Imposto.ICMS.pRedBC, DSC_PREDBC);
                    Gerador.wCampo(tcDe2, 'N15', 'vBC      ', 01, 15, 0, nfe.Det[i].Imposto.ICMS.vBC, DSC_VBC);
                    Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'N16', 'pICMS    ', 01, 05, 0, nfe.Det[i].Imposto.ICMS.pICMS, DSC_PICMS);
                    Gerador.wCampo(tcDe2, 'N16a', 'vICMSOp ', 01, 15, 0, nfe.Det[i].Imposto.ICMS.vICMSOp, DSC_VICMS);
                    Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'N16b', 'pDif    ', 01, 05, 0, nfe.Det[i].Imposto.ICMS.pDif, DSC_PICMS);
...
begin
  ...
  begin
    ...
    begin
      ...
      Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'O13', 'pIPI    ', 01, 05, 1, nfe.Det[i].Imposto.IPI.pIPI, DSC_PIPI);
      Gerador.wCampo(tcDe2, 'O14', 'vIPI    ', 01, 15, 1, nfe.Det[i].Imposto.IPI.vIPI, DSC_VIPI);
      Gerador.wGrupo('/IPITrib');
    end;
  end
...
begin
  ...
  begin
    ...
    Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'Q08', 'pPIS     ', 01, 05, 1, nfe.Det[i].Imposto.PIS.pPIS, DSC_PPIS);
...
begin
  ...
  begin
    ...
    begin
      ...
      Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'R03', 'pPIS     ', 01, 05, 1, nfe.Det[i].Imposto.PISST.pPis, DSC_PPIS);
...
begin
  ...
  begin
    ...
    Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'S08', 'pCOFINS  ', 01, 05, 1, nfe.Det[i].Imposto.COFINS.pCOFINS, DSC_PCOFINS);
...
begin
  ...
  begin
    ...
    begin
      ...
      Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'T03', 'pCOFINS    ', 01, 05, 1, nfe.Det[i].Imposto.COFINSST.pCOFINS, DSC_PCOFINS);
...
begin
  ...
  begin
    ...
    Gerador.wCampo(IIf(NFe.infNFe.Versao >= 3.10,tcDe4,tcDe2), 'U03', 'vAliq      ', 01, 05, 1, nfe.Det[i].Imposto.ISSQN.vAliq, DSC_VAliq);
