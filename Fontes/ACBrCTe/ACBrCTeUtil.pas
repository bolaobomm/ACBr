...
begin
  case ALayOut of
    ...
    LayCTeEvento:        Result := DFeUtil.SeSenao(AAmbiente = 1, 'https://cte.fazenda.pr.gov.br/cte/cteRecepcaoEvento?wsdl', 'https://homologacao.cte.fazenda.pr.gov.br/cte/cteRecepcaoEvento?wsdl');
  end;
end;
