...
// PASTLWTR : 1.2
// File generated on 3/3/2009 15:03:05 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Arquivos de programas\Microsoft CAPICOM 2.1.0.2 SDK\Lib\X86\capicom.dll (1)
...
// Errors:
//   Error creating palette bitmap of (TSettings) : No Server registered for this CoClass
//   Error creating palette bitmap of (TCertificate) : No Server registered for this CoClass
//   Error creating palette bitmap of (TCertificates) : No Server registered for this CoClass
//   Error creating palette bitmap of (TChain) : No Server registered for this CoClass
//   Error creating palette bitmap of (TStore) : No Server registered for this CoClass
//   Error creating palette bitmap of (TAttribute) : No Server registered for this CoClass
//   Error creating palette bitmap of (TSigner) : No Server registered for this CoClass
//   Error creating palette bitmap of (TSignedData) : No Server registered for this CoClass
//   Error creating palette bitmap of (TEnvelopedData) : No Server registered for this CoClass
//   Error creating palette bitmap of (TEncryptedData) : No Server registered for this CoClass
//   Error creating palette bitmap of (TOID) : No Server registered for this CoClass
//   Error creating palette bitmap of (TExtendedProperty) : No Server registered for this CoClass
//   Error creating palette bitmap of (TPrivateKey) : No Server registered for this CoClass
//   Error creating palette bitmap of (TSignedCode) : No Server registered for this CoClass
//   Error creating palette bitmap of (THashedData) : No Server registered for this CoClass
//   Error creating palette bitmap of (TUtilities) : No Server registered for this CoClass
// ************************************************************************ //
// *************************************************************************//
// NOTE:                                                                      
