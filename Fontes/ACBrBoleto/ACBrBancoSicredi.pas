     ...
     if trim(CodigoMora) = '' then
      ...
      begin
         wLinha:= '1'                                                                   +  // 001 a 001 - Identificação do registro detalhe
                  ...
                  padR(wNossoNumeroCompleto,9,'0');                               // 048 a 056 - Nosso número sem edição YYXNNNNND - YY=Ano, X-Emissao, NNNNN-Sequência, D-Dígito
...
begin
  ...
  begin
    ...
    Result:= '748'                                                          + // 001 a 003 - Código do banco na compensação
             ...
             padR(OnlyNumber(Agencia), 5,'0')                               + // 018 a 022 - Agência mantenedora da conta
             Space(1)                                                       + // 023 a 023 - Dígito verificador da agência
             padR(OnlyNumber(Conta), 12, '0')                               + // 024 a 035 - Número da conta corrente
